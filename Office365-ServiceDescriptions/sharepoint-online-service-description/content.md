...
## <a name="cross-site-publishing"></a>Publicação intersite
<a name="bkmk_WCMCrossSitePublishing"> </a>

Disponível apenas para os Conjuntos de sites privados. Publicação entre sites é um método de publicação. Permite que você crie e mantenha o conteúdo em um ou mais conjuntos de sites de autoria e publique esse conteúdo em um ou mais conjuntos de sites de publicação usando as Web Parts de pesquisa. Saiba como [ativar o recurso de Publicação entre sites](https://go.microsoft.com/fwlink/p/?LinkId=330810).
  
## <a name="design-manager"></a>Gerente de design
...
## <a name="document-translation-in-word-online"></a>Tradução de documento no Word Online
...
## <a name="faceted-navigation"></a>Navegação de faceta
...
## <a name="image-renditions"></a>Reprodução de imagens
...
Proteção das informações do Azure, uma tecnologia de proteção de informações no Office 365 usa o IRM Online do SharePoint. Proteção de IRM é aplicada aos arquivos nos níveis de lista e biblioteca do SharePoint. Saiba mais sobre o [IRM no SharePoint Online](https://go.microsoft.com/fwlink/?LinkId=270963).
...
## <a name="metadata-driven-navigation"></a>Navegação controlada por metadados
...
## <a name="multi-stage-disposition"></a>Disposição em várias fases
...
## <a name="office-online-view"></a>Office Online (visualizar)
...
## <a name="office-web-apps-server-integration"></a>Integração com o Office Web Apps Server
...
## <a name="preservation-hold-library"></a>Biblioteca de retenção para preservação
...
## <a name="publishing-analytics"></a>Análise de publicação
...
## <a name="site-mailbox"></a>Caixa de correio de Site
...
## <a name="unique-document-ids"></a>IDs exclusivos de documento
