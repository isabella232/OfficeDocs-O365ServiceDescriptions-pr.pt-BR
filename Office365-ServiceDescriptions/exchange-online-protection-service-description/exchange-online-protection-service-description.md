...
Para saber mais sobre novos recursos no EOP, confira [Novidades na Proteção do Exchange Online](https://docs.microsoft.com/office365/SecurityCompliance/eop/exchange-online-protection-overview). Para uma comparação de recursos entre o FOPE e EOP, confira [Comparação de recursos FOPE versus EOP](https://go.microsoft.com/fwlink/p/?LinkId=320391).
...
|**Plano**|**Descrição**|
|:-----|:-----|
|[EOP autônomo](https://docs.microsoft.com/office365/securitycompliance/eop/exchange-online-protection-overview) <br/> |Onde EOP protege suas caixas de correio locais.  <br/> |
|[Recursos EOP no Exchange Online](https://products.office.com/exchange/compare-microsoft-exchange-online-plans) <br/> |Onde EOP protege suas caixas de correio hospedadas em nuvem do Exchange Online.  <br/> |
|[Exchange Enterprise CAL com os serviços de](https://products.office.com/exchange/microsoft-exchange-licensing-faq-email-for-business) <br/> |Onde o EOP protege suas caixas de correio locais, como o EOP autônomo, e inclui a prevenção contra perda de dados (DLP) e criação de relatórios usando serviços Web.  <br/> |
...
Para saber mais sobre o licenciamento do Exchange Enterprise CAL com Serviços, confira [Licenciamento de Exchange Server 2013](https://products.office.com/exchange/microsoft-exchange-licensing-faq-email-for-business).
  
Se você tiver CAL Corporativa do Exchange com licenças de serviços e deseja configurar o serviço, siga as instruções em [Configurar seu serviço de EOP](https://docs.microsoft.com/office365/SecurityCompliance/eop/set-up-your-eop-service). As etapas de configuração são as mesmas para a configuração do EOP autônomo.
