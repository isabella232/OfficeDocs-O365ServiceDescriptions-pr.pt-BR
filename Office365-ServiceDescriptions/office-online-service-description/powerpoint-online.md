...
Não está disponível em PowerPoint Online. Recursos de formatação avançada, como mais cores, gradientes, conta-gotas, efeitos e estilos, estão disponíveis no aplicativo da área de trabalho PowerPoint. Com o PowerPoint Online, você pode adicionar uma caixa de texto ou escolher em uma galeria de formas e aplicar estilos, que irá definir efeitos de preenchimento, contorno e sombra. 
  
## <a name="apply-themes-and-theme-variants"></a>Aplicar temas e variações do tema
<a name="bkmk_ApplyThemes"> </a>

Escolha em uma galeria incorporada de temas e variações, quando você adicionar um novo slide à apresentação. Temas não suportados pelo PowerPoint Online são preservados na apresentação, mas a habilidade para modificar temas não está disponível no PowerPoint Online. Saiba mais sobre as [diferenças de uso de uma apresentação no navegador e no aplicativo da área de trabalho PowerPoint](https://go.microsoft.com/fwlink/?LinkId=272763).
  
## <a name="office-add-ins"></a>Suplementos do Office
<a name="bkmk_AppsOffice"> </a>

O PowerPoint Online apenas oferece suporte a complementos de conteúdo para o Office. Os complementos de conteúdo integram recursos baseados na Web como conteúdo que podem ser apresentados de acordo com a apresentação. Saiba mais sobre os [tipos de complementos do Office](https://go.microsoft.com/fwlink/p/?LinkId=282310).
...
Não é possível inserir tinta no PowerPoint Online, mas PowerPoint Online exibe conforme esperado.
...
O PowerPoint Online oferece suporte para oito transições e 37 animações. Para uma seleção maior, use o aplicativo da área de trabalho do PowerPoint. 
...
Com o PowerPoint Online, você pode inserir imagens armazenadas em seu computador ou inserir imagens do Bing Imagens. Você pode mover, redimensionar, cortar imagens e aplicar vários estilos de imagem. Os recursos mais sofisticados para trabalhar com as imagens, como aplicar efeitos, não estão disponíveis no PowerPoint Online. Você não pode criar capturas de tela no PowerPoint Online, mas capturas de tela que estão em uma apresentação aparecem como imagens no PowerPoint Online. Saiba mais sobre as [diferenças de uso de uma apresentação no navegador e no aplicativo da área de trabalho PowerPoint](https://go.microsoft.com/fwlink/?LinkId=272763).
...
Não está disponível em PowerPoint Online. Somente o aplicativo da área de trabalho Microsoft PowerPoint permite que um apresentador controle, nos bastidores, o fluxo, as observações, as anotações e as ferramentas de zoom de uma apresentação. O PowerPoint Online não oferece suporte a estes recursos.
  
## <a name="print-to-pdf"></a>Imprimir para PDF
<a name="bkmk_PrinttoPDF"> </a>

Com o PowerPoint Online, você pode imprimir sua apresentação em um leitor de PDF, em que todo o layout e formatação de seus slides serão impressos do jeito que você espera. Saiba mais sobre as [tarefas básicas que você pode fazer usando o PowerPoint Online](https://go.microsoft.com/fwlink/?LinkId=272775).
  
## <a name="proofing-tools"></a>Revisores de texto
<a name="bkmk_ProofingTools"> </a>

Você pode verificar a ortografia e definir o idioma de verificação, usando o dicionário incorporado com o PowerPoint Online. Mas o PowerPoint Online não usa dicionários personalizados e não inclui tradução ou um dicionário de sinônimos.
...
Com o PowerPoint Online, você pode executar sua apresentação, precisando apenas de um navegador e de uma conexão à Internet. Saiba mais sobre as [tarefas básicas que você pode fazer usando o PowerPoint Online](https://go.microsoft.com/fwlink/?LinkId=272775).
  
## <a name="save-as-or-download-a-copy"></a>Salvar como ou Baixar uma cópia
<a name="bkmk_Save"> </a>

O PowerPoint Online salva seu trabalho sempre que você fizer uma alteração. Não há nenhum comando Salvar. É possível baixar uma cópia, mas você deve ter o aplicativo da área de trabalho do Microsoft PowerPoint para editar a cópia local.
  
## <a name="shapes"></a>Formas
<a name="bkmk_Shapes"> </a>

Word Art e gráficos não podem ser inseridos no PowerPoint Online, mas PowerPoint Online exibe-os como esperado. No modo de exibição de Edição, edite e formate textos. Se você quiser aplicar efeitos de texto no Word Art, você precisará do aplicativo da área de trabalho Microsoft PowerPoint.
...
Com o PowerPoint Online, as notas de cada slide podem ser exibidas ou ocultas. Você também pode adicionar notas no modo de Edição.
