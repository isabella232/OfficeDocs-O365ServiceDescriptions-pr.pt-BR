...
> [!NOTE]
> <sup>1</sup> Esta é a cota de armazenamento da pasta Itens Recuperáveis, não a cota da caixa de correio de arquivamento inteira. A cota de armazenamento da caixa de correio de arquivamento é ilimitada para usuários com uma licença do Exchange Online (Plano 2) ou para usuários que têm uma licença do Exchange Online (Plano 1) e de Arquivamento do Exchange Online. Confira mais informações sobre o aumento da cota de Itens Recuperáveis em [Aumentar a cota de Itens Recuperáveis para caixas de correio em retenção](/microsoft-365/compliance/increase-the-recoverable-quota-for-mailboxes-on-hold).<br/> <sup>2</sup> A cota de armazenamento inicial da pasta Itens Recuperáveis em uma caixa de correio de arquivo morto é de 100 GB. Quando o arquivamento de expansão automática está ativado, o armazenamento adicional é incluído automaticamente quando é alcançada a capacidade da pasta de Itens Recuperáveis. Confira mais informações em [Visão geral de arquivamento ilimitado no Office 365](/microsoft-365/compliance/unlimited-archiving). Confira o [Roteiro do Microsoft 365](https://go.microsoft.com/fwlink/?LinkId=509914) para obter detalhes sobre a disponibilidade de arquivamento de expansão automática.
...
> [!NOTE]
> <sup>1</sup> A Microsoft recomenda até 1.000.000 mensagens por pasta da caixa de correio. ><br/> <sup>2</sup> Esta é a cota de armazenamento da pasta Itens Recuperáveis, não a cota da caixa de correio de arquivamento inteira. A cota de armazenamento da caixa de correio de arquivamento é ilimitada para usuários com uma licença do Exchange Online (Plano 2) ou para usuários que têm uma licença do Exchange Online (Plano 1) e de Arquivamento do Exchange Online. Confira mais informações sobre o aumento da cota de Itens Recuperáveis em [Aumentar a cota de Itens Recuperáveis para caixas de correio em retenção](/microsoft-365/compliance/increase-the-recoverable-quota-for-mailboxes-on-hold).<br/> <sup>3</sup> A cota de armazenamento inicial da pasta Itens Recuperáveis, na caixa de correio de arquivamento, é de 100 GB. Quando você ativa o arquivamento de expansão automática, nosso sistema inclui o armazenamento adicional automaticamente, quando a pasta de Itens Recuperáveis atinge a capacidade. Confira mais informações em [Visão geral de arquivamento ilimitado no Office 365](/microsoft-365/compliance/unlimited-archiving). Confira os detalhes sobre a disponibilidade do arquivamento de expansão automática no [Roteiro do Microsoft 365](https://go.microsoft.com/fwlink/?LinkId=509914).
