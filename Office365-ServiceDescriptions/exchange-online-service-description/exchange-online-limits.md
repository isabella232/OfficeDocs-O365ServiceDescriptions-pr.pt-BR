...
> [!NOTE]
>  Se você precisa de assistência com uma tarefa ou se você solucionar um problema, você pode encontrar os seguintes artigos úteis: > [Email](https://support.office.com/en-us/article/Email-94275804-7147-4332-9ccd-5d421760a9ed?ui=en-US&amp;rs=en-US&amp;ad=US) para obter ajuda criando e enviando email. > [Email no Office 365 para empresas - ajuda de Admin](https://go.microsoft.com/fwlink/?linkid=529722)> [problemas de Office 365 com o Assistente de recuperação para o Office 365 e o suporte da Microsoft e Outlook corrigir](https://diagnostics.office.com/)> [Email relatórios de entrega no Office 365](https://go.microsoft.com/fwlink/?linkid=526653)> [Exchange Ajuda online](https://go.microsoft.com/fwlink/?linkid=825607)
  
Os limites no Microsoft Exchange Online se encaixam em uma das seguintes categorias:
  
- [Limites de catálogo de endereços](#abl.md)
    
- [Limites de armazenamento de caixa de correio](#StorageLimits.md)
    
- [Alertas de capacidade](#CapacityAlerts.md)
    
- [Limites da pasta da caixa de correio](exchange-online-limits.md#MailboxFolderLimits)
    
- [Limites de mensagem](#MessageLimits.md)
    
- [Receber e enviar limites](#RecipientLimits.md)
    
- [Limites de rastreamento de mensagens e relatórios](exchange-online-limits.md#reporting-and-message-trace-limits)
    
- [Limites de retenção](#RetentionLimits.md)
    
- [Limites de grupos de distribuição](#DistributionGroupLimits.md)
    
- [Limites de regras de Diário, Transporte e Caixa de Entrada](#TransportRuleLimits.md)
    
- [Limites de moderação](#ModerationLimits.md)
    
- [Limites do Exchange ActiveSync](exchange-online-limits.md#exchange-activesync-limits)
...
|Caixas de correio de arquivo morto<sup>7, 8</sup> <br/> |50 GB  <br/> |50 GB  <br/> |50 GB  <br/> |Unlimited<sup>1</sup> <br/> |Ilimitado<sup>1</sup> <br/> |Não disponível<sup>4</sup> <br/> |
...
> [!NOTE]
> <sup>1</sup> A Microsoft recomenda até 1.000.000 mensagens por pasta da caixa de correio. > <sup>2</sup> Esta é a cota de armazenamento da pasta Itens Recuperáveis, não a cota da caixa de correio de arquivo morto inteira. A cota de armazenamento da caixa de correio de arquivo morto é ilimitada para usuários com uma licença do Exchange Online (Plano 2) ou para usuários que têm uma licença do Plano 1 do Exchange Online e de Arquivamento do Exchange Online. Confira mais informações sobre o aumento da cota de Itens Recuperáveis em [Increase the Recoverable Items quota for mailboxes on hold](http://technet.microsoft.com/library/a8bdcbdd-9298-462f-b889-df26037a990c.aspx). > <sup>3</sup> A cota de armazenamento inicial da pasta Itens Recuperáveis, na caixa de correio de arquivo morto, é de 100 GB. Quando você ativa o arquivamento de expansão automática, nosso sistema inclui o armazenamento adicional automaticamente, quando a pasta de Itens Recuperáveis atinge a capacidade. Confira mais informações em [Visão geral de arquivamento ilimitado no Office 365](https://go.microsoft.com/fwlink/?linkid=844060). Confira os detalhes sobre a disponibilidade do arquivamento de expansão automática no [Mapa do Office 365](http://go.microsoft.com/fwlink/?LinkId=509914). 
...
> [!NOTE]
> <sup>1</sup> Este é o limite padrão. Os administradores podem alterar esse valor para suas organizações. > <sup>2</sup> Este é o valor padrão para organizações do Exchange Online. Os administradores podem alterar esse valor para um máximo de 30 dias para caixas de correio em sua organização. 
...
> [!NOTE]
> <sup>1</sup> Este é o limite padrão para organizações do Exchange Server 2013. Os administradores podem alterar esse valor para sua organização. > <sup>2</sup> Esse limite também se aplica a administradores. 
