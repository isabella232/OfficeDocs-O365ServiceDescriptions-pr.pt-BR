...
> [!NOTE]
> <sup>1</sup> cada usuário recebe inicialmente 100 GB de armazenamento na caixa de correio de arquivo morto. Quando o arquivamento de expansão automática está ativado, o armazenamento adicional é automaticamente adicionado quando a capacidade de armazenamento de 100 GB é atingida. Para obter mais informações, consulte [Overview of Unlimited Archiving in Office 365](https://go.microsoft.com/fwlink/?linkid=844060). Consulte o [mapa do Office 365](http://go.microsoft.com/fwlink/?LinkId=509914) para obter detalhes sobre a disponibilidade.<br/>  <sup>2</sup> para acessar uma caixa de correio compartilhada, um usuário deve ter uma licença do Exchange Online. Caixas de correio comPartilhadas não exigem uma licença separada. No enTanto, sem uma licença, as caixas de correio compartilhadas são limitadas a 50 GB. Para aumentar o tamanho da caixa de correio, é necessário atribuir uma licença E3 ou e5. Isso aumentará a caixa de correio para 100 GB. Se você deseja habilitar a caixa de correio de arquivo morto ou colocar uma retenção de litígio em uma caixa de correio compartilhada, uma licença do Exchange Online Plan 2 ou uma licença do Exchange Online Plan 1 com o arquivamento do Exchange Online é necessária. Se você habilitar a caixa de correio de arquivo morto e o arquivamento de expansão automática para uma caixa de correio compartilhada, o armazenamento adicional será automaticamente adicionado quando a capacidade de armazenamento de 100 GB para a caixa de correio de arquivo morto for atingida.<br/>  <sup>3</sup> caixas de correio de recursos não exigem uma licença. No enTanto, sem uma licença, as caixas de correio compartilhadas são limitadas a 50 GB. Para aumentar o tamanho da caixa de correio, é necessário atribuir uma licença E3 ou e5. Isso aumentará a caixa de correio para 100 GB.<br/>  <sup>4</sup> caixas de correio de arquivo morto não estão incluídas no quiosque do Exchange Online. No enTanto, eles podem ser comprados como um complemento por meio do arquivamento do Exchange Online. Para obter mais informações, consulte a [Descrição do serviço de arquivamento do Exchange Online](../exchange-online-archiving-service-description/exchange-online-archiving-service-description.md).<br/>  <sup>cinco</sup> caixas de correio de site são criadas e gerenciadas no SharePoint Online. Para obter mais informações, consulte [preparar para usar caixas de correio de site no Office 365](http://go.microsoft.com/fwlink/p/?LinkId=299131).<br/>  <sup>6</sup> você está limitado a 1.000 caixas de correio de pasta pública e o tamanho máximo total de todas as caixas de correio de pasta pública é de 50 TB. A hierarquia que atende às caixas de correio é limitada a 100 caixas de correio de pasta pública.<br/>  <sup>7</sup> as caixas de correio de arquivo morto só podem ser usadas para arquivar emails para um único usuário ou entidade (como uma caixa de correio compartilhada) para a qual uma licença foi aplicada. O uso de caixas de correio de arquivo morto como meio de armazenamento de emails de vários usuários ou entidades é proibido. Por exemplo, um administrador de ti não pode criar uma caixa de correio compartilhada e fazer com que os usuários a copiem (por meio do campo CC ou Cco ou por meio de uma regra de transporte) para fins explícitos de arquivamento. Observe que uma caixa de correio compartilhada usada por várias pessoas não armazena, na verdade, emails para os usuários individuais. Vários usuários têm acesso e enviam emails como a caixa de correio compartilhada. Portanto, os únicos emails armazenados na caixa de correio compartilhada são aqueles enviados para ou dele, *como* a caixa de correio compartilhada.<br/>  <sup>8</sup> se você tiver criado uma política de retenção no Exchange Online, as mensagens serão automaticamente movidas para a caixa de correio de arquivo morto de um usuário se a caixa de correio principal do usuário for maior do que 10 MB. A política de retenção não será executada automaticamente para caixas de correio menores do que 10 MB.<br/>  <sup>9</sup> as caixas de correio compartilhadas e de recursos não exigem uma licença. No enTanto, sem uma licença, as caixas de correio compartilhadas são limitadas a 50 GB. Para aumentar o tamanho da caixa de correio, é necessário atribuir uma licença E3 ou e5. Isso aumentará a caixa de correio para 100 GB. 
...
> [!NOTE]
> <sup>1</sup> este é o tamanho de caixa de correio padrão para organizações do Exchange Server 2013. Os administradores podem alterar esse valor para sua organização. Não há um limite máximo de armazenamento para caixas de correio locais.<br/>  <sup>2</sup> cada usuário recebe inicialmente 100 GB de armazenamento na caixa de correio de arquivo morto. Quando o arquivamento de expansão automática está ativado, o armazenamento adicional é automaticamente adicionado quando a capacidade de armazenamento de 100 GB é atingida. Para obter mais informações, consulte [Overview of Unlimited Archiving in Office 365](https://go.microsoft.com/fwlink/?linkid=844060). Consulte o [mapa do Office 365](http://go.microsoft.com/fwlink/?LinkId=509914) para obter detalhes sobre a disponibilidade do arquivamento de expansão automática.<br/> <sup>3</sup> para acessar uma caixa de correio compartilhada, um usuário deve ter uma licença do Exchange Online. Caixas de correio comPartilhadas não exigem uma licença separada. No enTanto, sem uma licença, as caixas de correio compartilhadas são limitadas a 50 GB. Para aumentar o tamanho da caixa de correio, é necessário atribuir uma licença do Exchange Online Plan 2. Isso aumentará a caixa de correio para 100 GB. Se você deseja habilitar a caixa de correio de arquivo morto ou colocar uma retenção de litígio em uma caixa de correio compartilhada, uma licença do Exchange Online Plan 2 ou uma licença do Exchange Online Plan 1 com o arquivamento do Exchange Online é necessária. Se você habilitar a caixa de correio de arquivo morto e o arquivamento de expansão automática para uma caixa de correio compartilhada, o armazenamento adicional será automaticamente adicionado quando a capacidade de armazenamento de 100 GB para a caixa de correio de arquivo morto for atingida.<br/> <sup>4</sup> caixas de correio de recursos não exigem uma licença. No enTanto, sem uma licença, as caixas de correio compartilhadas são limitadas a 50 GB. Para aumentar o tamanho da caixa de correio, é necessário atribuir uma licença do Exchange Online Plan 2. Isso aumentará a caixa de correio para 100 GB.<br/>  <sup>5</sup> as caixas de correio de arquivo morto não estão incluídas no quiosque do Exchange Online. No enTanto, eles podem ser comprados como um complemento por meio do arquivamento do Exchange Online. Para obter mais informações, consulte a [Descrição do serviço de arquivamento do Exchange Online](../exchange-online-archiving-service-description/exchange-online-archiving-service-description.md).<br/>  <sup>6</sup> este é o tamanho de caixa de correio padrão para organizações do Microsoft Exchange Server 2013. Os administradores podem alterar esse valor para sua organização. No Exchange Server 2013, você está limitado a 100 caixas de correio de pasta pública e o tamanho máximo total de todas as caixas de correio de pasta pública é de 50 TB.<br/>  <sup>7</sup> no Exchange Online, você está limitado a 1.000 caixas de correio de pasta pública e o tamanho máximo total de todas as caixas de correio de pasta pública é de 50 TB.<br/>  <sup>8</sup> caixas de correio de arquivo morto só podem ser usadas para arquivar emails para um único usuário ou entidade para o qual uma licença foi aplicada. É proibido usar uma caixa de correio de arquivo morto como meio de armazenar emails de vários usuários ou entidades. Por exemplo, os administradores de ti não podem criar caixas de correio compartilhadas e fazer com que os usuários copiem (por meio do campo CC ou Cco, ou por uma regra de transporte) uma caixa de correio compartilhada para fins explícitos de arquivamento.<br/>  <sup>9</sup> se você tiver criado uma política de retenção no Exchange Online, as mensagens serão automaticamente movidas para a caixa de correio de arquivo morto de um usuário se a caixa de correio principal do usuário for maior do que 10 MB. A política de retenção não será executada automaticamente para caixas de correio menores do que 10 MB.<br/>  <sup>10</sup> caixas de correio compartilhadas e de recursos não exigem uma licença para serem atribuídas. No enTanto, sem uma licença, essas caixas de correio são limitadas a 50 GB. Para aumentar o tamanho da caixa de correio, é necessário atribuir uma licença do Exchange Online Plan 2. Isso aumentará a caixa de correio para 100 GB. 
  
> [!NOTE]
> Uma caixa de correio compartilhada não é projetada para logon direto. A conta de usuário para a própria caixa de correio compartilhada deve **** permanecer em um estado desabilitado (ou "desconectado"). 
...
> [!NOTE]
> <sup>1</sup> esta é a cota de armazenamento da pasta itens recuperáveis, não a cota da caixa de correio de arquivo morto inteira. A cota de armazenamento da caixa de correio de arquivo morto é ilimitada para os usuários com uma licença do Exchange Online Plan 2 ou para usuários que tenham uma licença de arquivamento do Exchange Online Plan 1 e do Exchange Online. Para obter informações sobre o aumento da cota de itens recuperáveis, consulte [aumentar a cota de itens recuperáveis para caixas de correio em espera](http://technet.microsoft.com/library/a8bdcbdd-9298-462f-b889-df26037a990c.aspx).<br/> <sup>2</sup> a cota de armazenamento inicial da pasta itens recuperáveis em uma caixa de correio de arquivo morto é de 100 GB. Quando o arquivamento de expansão automática está ativado, o armazenamento adicional é automaticamente adicionado quando a capacidade de armazenamento da pasta itens recuperáveis é atingida. Para obter mais informações, consulte [Overview of Unlimited Archiving in Office 365](https://go.microsoft.com/fwlink/?linkid=844060). Consulte o [mapa do Office 365](http://go.microsoft.com/fwlink/?LinkId=509914) para obter detalhes sobre a disponibilidade do arquivamento de expansão automática. 
...
|Aviso para o número de mensagens por pasta da caixa de correio  <br/> |Sem limite  <br/> |900.000  <br/> |900.000  <br/> |900.000  <br/> |
...
|Número máximo de subpastas por pasta de caixa de correio  <br/> |Sem limite  <br/> |1000  <br/> |1000  <br/> |1000  <br/> |
|Aviso para o número de subpastas por pasta de caixa de correio  <br/> |Sem limite  <br/> |900  <br/> |900  <br/> |900  <br/> |
|Profundidade máxima de hierarquia de pasta  <br/> |Sem limite  <br/> |300  <br/> |300  <br/> |300  <br/> |
|Aviso para a profundidade de hierarquia de pasta  <br/> |Sem limite  <br/> |250  <br/> |250  <br/> |250  <br/> |
...
> [!NOTE]
> <sup>1</sup> a Microsoft recomenda não mais do que 1 milhão mensagens por pasta da caixa de correio. GT<br/> <sup>2</sup> esta é a cota de armazenamento da pasta itens recuperáveis, não a cota da caixa de correio de arquivo morto inteira. A cota de armazenamento da caixa de correio de arquivo morto é ilimitada para os usuários com uma licença do Exchange Online Plan 2 ou para usuários que tenham uma licença de arquivamento do Exchange Online Plan 1 e do Exchange Online. Para obter informações sobre o aumento da cota de itens recuperáveis, consulte [aumentar a cota de itens recuperáveis para caixas de correio em espera](http://technet.microsoft.com/library/a8bdcbdd-9298-462f-b889-df26037a990c.aspx).<br/> <sup>3</sup> a cota de armazenamento inicial da pasta itens recuperáveis em uma caixa de correio de arquivo morto é de 100 GB. Quando o arquivamento de expansão automática está ativado, o armazenamento adicional é automaticamente adicionado quando a capacidade de armazenamento da pasta itens recuperáveis é atingida. Para obter mais informações, consulte [Overview of Unlimited Archiving in Office 365](https://go.microsoft.com/fwlink/?linkid=844060). Consulte o [mapa do Office 365](http://go.microsoft.com/fwlink/?LinkId=509914) para obter detalhes sobre a disponibilidade do arquivamento de expansão automática. 
...
> [!NOTE]
> <sup>1</sup> o tamanho máximo de mensagem padrão para caixas de correio do Office 365 é de 25 MB. Os administradores do Office 365 podem especificar um limite personalizado entre 1 MB e 150 MB. No enTanto, o tamanho da mensagem que você pode enviar ou receber também depende do que o cliente de email ou a solução suporta. Para obter mais informações sobre como personalizar o tamanho máximo permitido da mensagem para sua organização, consulte o [Office 365 agora oferece suporte a mensagens de email maiores](https://blogs.office.com/2015/04/15/office-365-now-supports-larger-email-messages-up-to-150-mb/).<br/> <sup>2</sup> você pode enviar e receber até 150 MB de mensagens entre os usuários do Office 365 (onde a mensagem nunca deixa os datacenters do Office 365). As mensagens que são roteadas fora dos datacenters do Office 365 estão sujeitas a uma codificação de conversão de 33% adicional e, nesse caso, o tamanho máximo da mensagem é de 112 MB.<br/> <sup>3</sup> contas do OWA para a possibilidade de que sua mensagem esteja sujeita ao aumento da codificação 33% e restringe o tamanho da mensagem que você pode enviar para 25% menor do que a configuração configurada. Por exemplo, se você personalizar suas configurações para um tamanho máximo de mensagem de 100 MB, poderá enviar mensagens que não sejam maiores que 75 MB.<br/> <sup>4</sup> O tamanho das mensagens a serem movidas para o Exchange Online será calculado pelo Exchange Online. Versões do Exchange anteriores ao Exchange Server 2013 podem relatar um tamanho menor de item. Esse limite se aplica para mover as migrações com base usando qualquer Serviço de Replicação de Caixa de Correio do Exchange. Outros métodos de migração (Substituição, Em Estágios, IMAP, PST) e outras ferramentas de terceiros são limitadas pelo limite geral de tamanho de mensagem.<br/> <sup>5</sup> para obter informações sobre o ome com novos recursos, confira [configurar os novos recursos de criptografia de mensagens do Office 365 criados na parte superior da proteção de informações do Azure](https://support.office.com/en-us/article/Set-up-new-Office-365-Message-Encryption-capabilities-built-on-top-of-Azure-Information-Protection-7ff0c040-b25c-4378-9904-b1b50210d00e?ui=en-US&amp;rs=en-US&amp;ad=US).<br/> <sup>6</sup> Não é possível anexar um arquivo com mais de 35 MB. Também não é possível anexar arquivos que juntos ultrapassam 35 MB. Por exemplo, se você anexar um arquivo de 34 MB, só poderá anexar outro de 1 MB. 
...
|Limite de anexos de arquivo  <br/> |1024 anexos<sup>4</sup> <br/> |250 anexos  <br/> |250 anexos  <br/> |250 anexos  <br/> |
...
> [!NOTE]
> <sup>1</sup> os administradores do Office 365 podem especificar um limite personalizado entre 1 mb e 150 MB. No enTanto, o tamanho da mensagem que você pode enviar ou receber também depende do que o cliente de email ou a solução suporta. Para obter mais informações sobre como personalizar o tamanho máximo permitido da mensagem para sua organização, consulte o [Office 365 agora oferece suporte a mensagens de email maiores](https://blogs.office.com/2015/04/15/office-365-now-supports-larger-email-messages-up-to-150-mb/).<br/> <sup>2</sup> você pode enviar e receber até 150 MB de mensagens entre os usuários do Office 365 (onde a mensagem nunca deixa os datacenters do Office 365). As mensagens que são roteadas fora dos datacenters do Office 365 estão sujeitas a uma codificação de conversão de 33% adicional e, nesse caso, o tamanho máximo da mensagem é de 112 MB.<br/> <sup>3</sup> contas do OWA para a possibilidade de que sua mensagem esteja sujeita ao aumento da codificação 33% e restringe o tamanho da mensagem que você pode enviar para 25% menor do que a configuração configurada. Por exemplo, se você personalizar suas configurações para um tamanho máximo de mensagem de 100 MB, poderá enviar mensagens que não sejam maiores que 75 MB.<br/> <sup>4</sup> este é o limite padrão para organizações do Exchange Server 2013. Os administradores podem alterar esse valor para sua organização.<br/> <sup>5</sup> o tamanho das mensagens a serem movidas para o Exchange Online são calculados pelo Exchange Online. As versões do Exchange anteriores ao Exchange Server 2013 podem relatar um tamanho de item menor.<br/> <sup>6</sup> para obter informações sobre o ome com novos recursos, confira [configurar os novos recursos de criptografia de mensagens do Office 365 criados na parte superior da proteção de informações do Azure](https://support.office.com/en-us/article/Set-up-new-Office-365-Message-Encryption-capabilities-built-on-top-of-Azure-Information-Protection-7ff0c040-b25c-4378-9904-b1b50210d00e?ui=en-US&amp;rs=en-US&amp;ad=US). 
...
> [!NOTE]
> <sup>1</sup> Este é o limite padrão. Os Administradores podem alterar esse valor para suas organizações.<br/> <sup>2</sup> este é o valor padrão para organizações do Exchange Online. Os administradores podem alterar esse valor para, no máximo, 30 dias para caixas de correio em sua organização. 
...
> [!NOTE]
> <sup>1</sup> se você estiver usando o DirSync do Azure Active Directory, o número máximo de membros do grupo de distribuição que você pode sincronizar de seu Active Directory local para o Azure active directory é 15.000. Se você estiver usando o Azure AD Connect, esse número será 50.000.<br/> <sup>2</sup> Esse limite também se aplica a administradores. 
...
|Limite de exclusão do dispositivo do Exchange ActiveSync  <br/> |508  <br/> |508  <br/> |508  <br/> |508  <br/> |508  <br/> |508  <br/> |
...
|Limite de exclusão do dispositivo do Exchange ActiveSync  <br/> |508  <br/> |508  <br/> |508  <br/> |508  <br/> |
