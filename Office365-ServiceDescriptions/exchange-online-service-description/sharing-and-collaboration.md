...
>
>  O compartilhamento de listas de acesso global (GALs) ou a movimentação de caixas de correio de usuário entre organizações do Exchange Online em diferentes planos da Microsoft não é suportado no compartilhamento federado. 
...
> [!IMPORTANT]
> Seu plano deve incluir o SharePoint. As caixas de correio de site requerem que os usuários tenham licenças de SharePoint e Exchange. 
...
Normalmente, caixas de correio de grupo ou compartilhadas não exigem uma licença de usuário separada. No entanto, para habilitar In-Place arquivo morto para um grupo ou uma caixa de correio compartilhada, você deve atribuir uma licença do Plano 1 do Exchange Online ou do Plano 2 do Exchange Online a ele. Depois que a licença for atribuída, o tamanho da caixa de correio aumentará de acordo com o plano licenciado. Para colocar uma caixa de correio compartilhada em In-Place, você deve atribuir uma licença do Plano 2 do Exchange Online a ela. Observe que as caixas de correio de grupo não podem ser atribuídas no momento, mas devem ser contabiladas no total de licenças.
