...
|Configurar aplicativo de PCs escolares|Não|Não|Não|Sim|Sim|Não|Não|Não|Não|
...
|Criptografia avançada de mensagens do Office 365|Não|Não|Sim|Não|Sim|Não|Não|Não|Não|
