...
> [!IMPORTANT]
> O Microsoft Teams está enfrentando um pico enorme em chamadas online e conferência de áudio/vídeo devido à pandérmica do coronavirus (COVID-19).<br/>
>
>Em resposta ao aumento sem precedentes nas chamadas e para garantir a continuidade e a disponibilidade, a Microsoft está permitindo que os servidores de áudio/vídeo GCC do Microsoft Teams aproveitem a capacidade de processamento em nossos datacenters comerciais, bem como em nossos datacenters governamentais.<br/>
>
>Esses servidores de áudio/vídeo residem nos servidores de limite de alta certificação do Microsoft Azure FedRAMP nos Estados Unidos e não armazenam conteúdo de cliente. No entanto, esses servidores estão processando áudio e vídeo para chamadas e conferências e estão operando sob nossa equipe comercial durante esse período provisório.<br/>
>
>Equipes qualificadas e analisadas estão monitorando esses servidores em busca de acesso potencial aos dados do cliente revendo os logoff interativos desses servidores. A equipe qualificada atendem aos requisitos da GCC para acesso ao conteúdo do cliente. Para obter detalhes sobre os requisitos de triagem, consulte a [descrição do serviço GCC.](gcc.md)<br/>
>
>Agradecemos o suporte à medida que as etapas são tomadas para garantir que nossos serviços permaneçam disponíveis e confiáveis nesses tempos de ajuda.<br/>

Em resposta aos requisitos exclusivos e em evolução do setor público dos Estados Unidos, a Microsoft criou planos do Office 365 Government (ou o Office 365 Government). Esta descrição de serviço fornece uma visão geral dos recursos específicos dos ambientes do Office 365 Government US. Recomendamos que você leia essa descrição de serviço junto com outras descrições de serviço do [Microsoft 365 e office 365.](../../office-365-service-descriptions-technet-library.md)
...
- O ambiente do **Office 365 GCC** fornece conformidade com os requisitos federais para serviços de nuvem, incluindo o FedRAMP High e requisitos para processos criminais e sistemas de informações fiscais federais (tipos de dados CJI e FTI).

- Os ambientes do **Office 365 GCC High** e DoD oferecem conformidade com as Diretrizes de Requisitos de Segurança do Departamento de Defesa, o DFARS (Federal Acquisition Regulations Supplement) de Defesa e o ITAR (Regulamento Internacional de Tráfego de Armas).

Além dos recursos e capacidades do Office 365, as organizações que usam o Office 365 Government se beneficiam dos seguintes recursos exclusivos do Office 365 Government:
...
- O Office 365 Government está em conformidade com certificações e certificações necessárias para clientes do Setor Público dos EUA.
...
Embora os critérios de qualificação sejam consistentes em ofertas do Office 365 Government, a Microsoft concordará apenas com a linguagem de contrato da DFARS e do ITAR para o ambiente GCC High.

As entidades com dúvidas sobre a qualificação para o Office 365 Government devem consultar sua equipe de conta.

Após a renovação do contrato de um cliente para o Office 365 Government, a revalidação de qualificação é necessária.
...
- Conversas arquivadas, documentos carregados e sessões de quadro de diálogo do Skype for Business
...
Se os usuários estão localizados nos EUA enquanto usam o Office para a Web (anteriormente conhecido como Office Web Apps) ou se você adotar o uso dos Serviços de Federação do Active Directory (AD FS) 2.0 e configurar políticas para ajudar a garantir que seus usuários se conectem aos serviços por meio de logor único, qualquer conteúdo de cliente temporariamente armazenado em cache no Office para a Web será localizado nos EUA.

A página de uso do site para sites do SharePoint está disponível para planos governamentais, embora, de acordo com a conformidade, existem alguns recursos desta página que só estão disponíveis para clientes comerciais. Para saber mais, confira [a página de uso do site para sites do SharePoint no Microsoft 365.](https://support.microsoft.com/office/2fa8ddc2-c4b3-4268-8d26-a772dc55779e)

## <a name="office-365-government-and-third-party-services"></a>Office 365 Government e serviços de terceiros

O Office 365 oferece a capacidade de integrar aplicativos de terceiros a sites do SharePoint Online, Skype for Business, aplicativos do Office incluídos no Microsoft 365 Apps para empresas (como Word, Excel, PowerPoint e Outlook) e Outlook Web App. Além disso, o Office 365 suporta a integração com provedores de serviços de terceiros. Estes aplicativos e serviços de terceiros podem envolver o armazenamento, a transmissão e o processamento dos dados de cliente da sua organização em sistemas de terceiros que estão localizados fora da infraestrutura do Office 365 e, portanto, não são cobertos pelos compromissos de conformidade e proteção de dados do Office 365. Recomendamos que você analise as instruções de privacidade e conformidade fornecidas por terceiros quando estiver avaliando o uso apropriado destes serviços para sua organização.

## <a name="restricted-data-access-by-administrators"></a>Acesso restrito aos dados pelos administradores

O acesso ao conteúdo do cliente do Office 365 Government pelos administradores da Microsoft é restrito à equipe de triização. Para obter detalhes sobre níveis de triagem, consulte a página de descrição do serviço para cada ambiente respectivo (GCC ou GCC High e DoD).

## <a name="fasttrack-center-onboarding-assistance"></a>Assistência de integração do Centro FastTrack

Com os Benefícios do Centro FastTrack para o Office 365<sup>1,</sup>você trabalha remotamente com Especialistas do FastTrack para preparar seu ambiente do Office 365 para uso e planejar a distribuição e o uso em sua organização. O processo FastTrack oferece integração e serviços de adoção do usuário. 

A integração consiste em:

- Integração básica – são tarefas necessárias para configuração de locatário e integração com o Azure Active Directory (Azure AD), se necessário. A integração básica também fornece a linha de base para integração de outros serviços qualificados.

- Integração e migração de serviço – as tarefas de integração de serviço permitem cenários em seu locatário. A migração de dados (incluindo emails e arquivos) é abordada na [Migração de Dados.](https://aka.ms/whatcanmigrate) <sup>2</sup>

Os serviços de adoção de usuários são compostos de tarefas que fornecem orientações para garantir que os usuários estão cientes dos serviços qualificados e podem usá-los para impulsionar o valor dos negócios. Esta assistência ocorre paralelamente às atividades de integração.

Informações específicas sobre o processo do Centro FastTrack podem ser [encontradas aqui.](https://aka.ms/whatistheprocess) Para uma divisão de funções e responsabilidades de envolvimento, revise as responsabilidades [do FastTrack,](https://aka.ms/whatdoesftcdo) bem como [suas responsabilidades.](https://aka.ms/whatdowedo)

> <sup>1</sup> Você deve adquirir pelo menos 50 licenças da lista de planos qualificados [para](https://aka.ms/whocanbenefit) receber os serviços do FastTrack.
<br/><sup>2 Serviços</sup> de Migração de Dados estão disponíveis para locatários do Office 365 com 500 ou mais licenças.

## <a name="data-migrations-performed-by-fasttrack"></a>Migrações de dados executadas pelo FastTrack
...
|Pesquisa de número de seguro social (SSN)|Sim|Sim|
...
Os clientes do Office 365 US Government podem usar os serviços do Azure Government ExpressRoute para se conectarem de forma privada aos serviços suportados do Office 365 em vez de se conectarem pela Internet pública.
...
Para obter informações sobre o Centro &amp; de Conformidade de Segurança e links para informações e disponibilidade adicionais, consulte o Centro de Conformidade [de &amp; Segurança.](../../office-365-platform-service-description/office-365-securitycompliance-center.md)
...
> <sup>1</sup> O Skype for Business Basic está disponível para todos os clientes. O cliente de desktop do Skype for Business é um aplicativo instalado localmente que fornece recursos de presença, mensagens instantâneas e conferências para planos do Office 365 que incluem o Skype for Business online. Os Aplicativos do Microsoft 365 para empresas, G3 e G5 incluem o aplicativo completo do Skype, que inclui recursos adicionais, como suporte avançado a telefonia, arquivamento e recursos de conformidade. A Skype for Business Online license must be assigned for each user.
<br/><sup>2</sup> Não incluído, mas pode ser adquirido como um complemento separado. O Project Online inclui o Cliente de Área de Trabalho do Project Online como parte da assinatura.
<br/> <sup>3</sup> Ainda não está disponível nos planos GCC High ou DoD, mas estará disponível em breve.
<br/><sup>4</sup> O Yammer Enterprise não é um componente do Office 365 US Government, mas pode ser adquirido sem custo como uma oferta autônoma para cada usuário licenciado para o Office 365 na GCC. No momento, essa oferta está limitada aos clientes que compram o Office 365 GCC sob Contratos Empresariais e Contratos de Assinatura Empresarial. O Yammer não está disponível em GCC High ou DoD.
<br/><sup>5</sup> Plano de Chamada é um complemento.
<br/><sup>6</sup> Não incluído, mas pode ser adquirido como um complemento separado. O Visio para a Web inclui o aplicativo da área de trabalho do Visio como parte da assinatura.
...
|Autenticação de fator telefônico|Sim<sup>9</sup>|Sim<sup>9</sup>|Sim|Sim<sup>9</sup>|
...
|Status de alertas individuais disponíveis no painel do Centro de administração do Microsoft 365|Sim<sup>9, 15</sup>|Sim<sup>9, 15</sup>|Sim<sup>9, 15</sup>|Sim<sup>9, 15</sup>|
...
|Opção para ativar o Lançamento Direcionado|Sim<sup>10</sup>|Sim<sup>10</sup>|Sim<sup>10</sup>|Sim<sup>10</sup>|
...
|Segurança no Aplicativo na Nuvem|Não<sup>12, 15, 19</sup>|Não<sup>12, 15, 19</sup>|Sim<sup>15, 19</sup>|Não<sup>12, 15, 19</sup>|
|Obter o Microsoft Defender para Office 365|Não<sup>12, 18</sup>|Não<sup>12, 18</sup>|Sim<sup>18</sup>|Não<sup>12, 18</sup>|
...
|Classificação de<sup>Segurança 14</sup>|Sim<sup>9, 15</sup>|Sim<sup>9</sup>|Sim<sup>9, 15</sup>|Sim<sup>9, 15</sup>|
...
<br/><sup>2</sup> Clientes atuais do BBCS e do BIS podem continuar a usar o serviço. No momento, não aceitamos novos clientes.
...
<br/><sup>4</sup> Se estiver usando a sincronização de senha, os usuários deverão alterar suas senhas no Active Directory local.
<br/><sup>5</sup> Para saber como definir políticas de gerenciamento de senha de autoatendado para os usuários, confira [Gerenciar Senhas no Azure AD.](https://azure.microsoft.com/documentation/articles/active-directory-manage-passwords/)
<br/><sup>6</sup> Você pode ter apenas um site público com o Office 365, a menos que tenha atualizado de uma versão anterior do Office 365. Nesse caso, é possível ter dois sites públicos, mas somente um deles pode ser hospedado com um nome de domínio personalizado. Para saber mais sobre como trabalhar com os dois sites para assinaturas de empresas, confira Trabalhar com seus dois sites públicos do [Office 365.](https://go.microsoft.com/fwlink/p/?LinkID=271589) Se você tiver uma assinatura diferente, saiba mais sobre sites públicos em Saiba mais sobre a hospedagem de sites de parceiros e sites públicos [no Office 365.](https://go.microsoft.com/fwlink/p/?LinkID=325009)
<br/><sup>7</sup> Reduzir usuários adquiridos com um desconto pode estar sujeito a uma taxa de término antecipado. Isso não é aplicável a assinaturas pagas mensalmente.
<br/><sup>8</sup> Os planos a seguir não suportam alterações de assentos de licença do Centro de administração do Microsoft 365: Office 365 Government G1, Office 365 Government G3, Office 365 Government F3.
<br/><sup>9</sup> Ainda não está disponível no GCC High, mas estará disponível em breve.
<br/><sup>10</sup> For Office 365 Government G1, G3, and F3, Targeted release and the Office 365 for business roadmap apply; No entanto, pode haver algumas diferenças ou atrasos para atualizações de serviço específicas devido aos requisitos [de conformidade.](https://www.microsoft.com/trust-center)
<br/><sup>11</sup> Ainda não está disponível nas ofertas do Office 365 Government, mas estará disponível em breve.
<br/><sup>12</sup> Não incluído, mas pode ser adquirido como um complemento separado no GCC.
<br/><sup>13</sup> Sem suporte para ofertas do Office 365 Government.
...
<br/><sup>15</sup> Ainda não está disponível no ambiente do DoD, mas estará disponível em breve.
<br/><sup>16</sup> Centro de administração não inclui análise de uso em ambientes DoD ou GCC High.
<br/><sup>17</sup> Sem suporte para ambientes GCC High ou DoD.
<br/><sup>18</sup> Anti-phishing para representação de usuário e domínio e inteligência contra spoof ainda não estão disponíveis no GCC High e DoD.
<br/><sup>19</sup> Ainda não está disponível no ambiente GCC, mas estará disponível em breve.
<br/><sup>Consumo de 20</sup> apenas para o Microsoft Stream: sem publicação ou compartilhamento.
<br/><sup>21</sup> Não disponível para a API do Microsoft Graph ou o Microsoft Teams.

## <a name="office-application-availability-and-enterprise-value"></a>Disponibilidade de aplicativos do Office e valor empresarial
...
|**Valor empresarial**|**Office 365 Government G1**|**Office 365 Government G3**|**Office 365 Government G5**|**Office 365 Government F3**|
...
<br/><sup>4</sup> Ainda não está disponível em ambientes GCC High ou DoD, mas estará disponível em breve.
<br/><sup>5</sup> Consulte [Usar o Outlook para iOS e Android na Nuvem da Comunidade Governamental](https://docs.microsoft.com/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/outlook-for-ios-and-android-in-the-government-cloud) para obter mais detalhes.
<br/><sup>6</sup> Ainda não está disponível no ambiente do Office 365 DoD, mas estará disponível em breve.
<br/><sup>7</sup> Os aplicativos estão totalmente disponíveis nas nuvens governamentais, com exceção dos recursos específicos não disponíveis no momento. Confira [a disponibilidade de recursos do aplicativo do Office](#office-application-and-feature-availability-in-government-plans) para obter detalhes.
...
Os seguintes aplicativos do Office estão disponíveis nas nuvens governamentais; No entanto, alguns recursos baseados em nuvem podem não estar disponíveis no momento, conforme indicado na tabela.<br><br>
...
|Colaboração em tempo real (presença, coautor regular, chat no documento)|Não|Não|Não|
|Shared with Me|Não|Não|Não|
|Pesquisa Inteligente|Não|Não|Não|
|Gráficos: mapa de árvore de sol, cascata, histograma, mapas, linha do tempo, funil|Não|Não|Não|
...
|Troca dinâmica de dados (DDE) desabilitada por padrão|Não|Não|Não|
...
|Técnico do Apresentador|Não|Não|Não|
|Shared with Me|Não|Não|Não|
|Integração do Skype for Business com o compartilhamento|Não|Não|Não|
|Histórico de versão|Não|Não|Não|
|Grupos do Office 365|Não|Não|Não|
|Colaboração em tempo real (presença, coautor regular, chat no documento)|Não|Não|Não|
|Ditado|Não<sup>1</sup>|Não<sup>1</sup>|Não<sup>1</sup>|
|Reutilizar slides|Não|Não|Não|
|**No momento, o Microsoft Whiteboard** em nuvens governamentais só está disponível em clientes hub, e não na área de trabalho.|**GCC**<sup>2</sup>|**GCC High**<sup>2</sup>|**DOD**<sup>2</sup>|
|Inserir anotações, texto e imagens sticky|Sim<sup>2</sup> <br/>|Sim<sup>2</sup> <br/>|Sim<sup>2</sup> <br/>|
|Tinta em forma e tinta na tabela|Sim<sup>2</sup> <br/>|Sim<sup>2</sup> <br/>|Sim<sup>2</sup> <br/>|
...
Para disponibilidade de recursos do Microsoft Teams no GCC/GCC High/DoD, visite a [descrição do serviço do Microsoft Teams.](https://docs.microsoft.com/office365/servicedescriptions/teams-service-description)
...
<br/><sup>4</sup> O recurso de formulários de grupo recentes está desabilitado para o ambiente GCC. Os usuários, no entanto, ainda podem acessar formulários de grupo selecionando um grupo específico na guia Formulários de grupo.
<br/><sup>5</sup> Word, Excel PowerPoint Windows client only, not web, MacOS, iOS or Android.
