...
Para obter informações detalhadas sobre o plano sobre assinaturas que permitem usuários para Power BI, consulte a tabela de comparação [de assinatura completa](https://go.microsoft.com/fwlink/?linkid=2139145).
 
## <a name="power-bi-plans"></a>Planos do Power BI

Você pode se inscrever no plano de Power BI [que](https://go.microsoft.com/fwlink/?LinkID=786854) melhor se adapte às suas necessidades. 
