...
Como um serviço online da Microsoft, o arquivamento do Exchange Online foi projetado para ajudar a atender à necessidade de segurança robusta, confiabilidade e produtividade do usuário. Para obter mais informações sobre o Microsoft 365, incluindo recursos comuns a todos os serviços online da Microsoft, consulte a [Descrição do serviço da plataforma do Office 365](../office-365-platform-service-description/office-365-platform-service-description.md).
...
> [!TIP]
> Você pode exportar, salvar e imprimir páginas nas descrições de serviço. Saiba como [exportar várias páginas](https://docs.microsoft.com/office365/securitycompliance/export-search-results). 
