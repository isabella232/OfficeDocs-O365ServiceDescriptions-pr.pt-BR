...
|||
|:-----|:-----|
|**Alterações que exigem ação (plano de alteração)**         Os administradores são solicitados a fazer alterações para manter o serviço em execução, as atualizações têm um impacto sobre a conformidade da organização  <br/> |Centro de Mensagens do Office 365 Direciona emails para os administradores verificados do Yammer Mapa do Office 365Grupo Externo de Atualizações de Serviço do YammerCom as alterações que afetam um conjunto direcionado de usuários, talvez também notifiquemos diretamente esses usuários. |
|**Alterações que exigem conscientização (mantenha-se informado)**         Alterações que não exigem medidas do administrador, alterações visuais de design  <br/> |Centro de Mensagens do Office 365 Mapa do Office 365Grupo Externo de Atualizações de Serviço do YammerCom as alterações que afetam um conjunto direcionado de usuários, talvez também notifiquemos diretamente esses usuários. |
|**Não críticas**         Alterações que não são críticas e que não exigem medidas ou reconhecimento, mesmo que possam ser observadas por outros usuários  <br/> |Não serão amplamente comunicadas. |
   
## <a name="feature-availability-across-yammer-plans"></a>Disponibilidade de recurso nos planos do Yammer
<a name="YammerCommsPolicy"> </a>

Precisa de ajuda para saber qual plano do Yammer é o melhor para as necessidades da sua organização? Use a tabela a seguir para ver quais recursos estão disponíveis em cada plano. Clique no nome de um recurso para ler um breve resumo de como ele funciona no Yammer.
...
|[Perfis de usuário](profile-features-in-yammer.md#user-profiles) <br/> |Sim  <br/> |Sim  <br/> |
|[Especialização](profile-features-in-yammer.md#expertise) <br/> |Sim  <br/> |Sim  <br/> |
|[Diretório de membros](profile-features-in-yammer.md#member-directory) <br/> |Sim  <br/> |Sim  <br/> |
...
|[Pesquisa da Caixa de Entrada](inbox-features-in-yammer.md#inbox-search) <br/> |Sim  <br/> |Sim  <br/> |
...
|[Preenchimento Automático](discovery-features-in-yammer.md#instant-type-ahead) <br/> |Sim  <br/> |Sim  <br/> |
|[Redes Externas](external-network-features-in-yammer.md#external-networks) <br/> |Sim  <br/> |Sim  <br/> |
|[Troca Rápida de Rede](external-network-features-in-yammer.md#fast-network-switching) <br/> |Sim  <br/> |Sim  <br/> |
|[Login de Conexão do Yammer](yammer-platform-features.md#yammer-connect-login) <br/> |Sim  <br/> |Sim  <br/> |
|[Feeds Incorporados](yammer-platform-features.md#embeddable-feeds) <br/> |Sim  <br/> |Sim  <br/> |
|[Botões de Curtir e Seguir](yammer-platform-features.md#like-and-follow-buttons) <br/> |Sim  <br/> |Sim  <br/> |
|[Extensão do Navegador](yammer-platform-features.md#browser-extension) <br/> |Sim  <br/> |Sim  <br/> |
|[API do Fluxo de Atividade](yammer-platform-features.md#activity-stream-api) <br/> |Sim  <br/> |Sim  <br/> |
|[Atribuição de Marca Personalizada para a Rede](administration-and-security-features-in-yammer.md#custom-network-branding) <br/> |Não  <br/> |Sim  <br/> |
...
|[Recursos da Empresa](administration-and-security-features-in-yammer.md#company-resources) <br/> |Sim  <br/> |Sim  <br/> |
...
|[FastTrack Center](http://go.microsoft.com/fwlink/?LinkID=518597&amp;clcid=0x409) <br/> |Não  <br/> |Sim  <br/> |
...
|[Modo de conteúdo particular de administrador](administration-and-security-features-in-yammer.md#admin-private-content-mode) <br/> |Não  <br/> |Sim  <br/> |
