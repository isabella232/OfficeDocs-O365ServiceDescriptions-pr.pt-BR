...
ms.locfileid: "24034804"
---
# <a name="microsoft-365-business-service-description"></a>Descrição dos serviços do Microsoft 365 Business

Microsoft 365 Business é uma solução integrada unindo a produtividade melhor classe do Office 365 com recursos avançados de gerenciamento de segurança e o dispositivo para ajudar a proteger sua empresa. . Essa descrição de serviço descreve os recursos e opções do plano. Para obter mais informações sobre o Office 365, consulte as [Descrições do serviço do Office 365 ](office-365-service-descriptions-technet-library.md).
  
## <a name="feature-availability-across-office-365-business-premium-and-microsoft-365-business-plans"></a>Disponibilidade de recursos nos planos do Office 365 Business Premium e Microsoft 365 Business

A tabela a seguir lista os recursos de plataforma para planos Business Premium do Office 365 e Microsoft 365 Business.
  
Para exibir a disponibilidade de recursos nos planos do Office 365, consulte a [Descrição do serviço de plataforma do Office 365](office-365-platform-service-description/office-365-platform-service-description.md).
...
|Administrar o Office 365 usando o Centro de administração do Office 365 ou o Windows PowerShell  <br/> |Sim  <br/> |Sim  <br/> |
|Proteger o conteúdo usando a Proteção de Informações do Azure  <br/> |Nenhum<sup>6</sup> <br/> |Sim  <br/> |
...
|Ferramenta de sincronização do AD conectar Azure  <br/> |Sim  <br/> |Sim<sup>7</sup> <br/> |
...
|Marcas de retenção de gerenciamento de registros (MRM) mensagens e políticas de retenção  <br/> |Sim  <br/> |Sim  <br/> |
...
|||
|:-----|:-----|
|**Recursos de gerenciamento do Windows 10** - Microsoft 365 Business facilita gerenciar dispositivos. Quando você configura seu locatário do Microsoft 365 Business você selecionar a proteção de aplicativos e definições de configuração de dispositivo. Essas configurações determinam as diretivas que são aplicadas automaticamente aos dispositivos quando eles entrarem Azure Active Directory. Recursos de gerenciamento do Windows 10 Pro incluem:<br/> |**Microsoft 365 Business** <br/> |
|Implantação simplificada com piloto automático do Windows  <br/> |Sim  <br/> |
|Ativação da assinatura  <br/> |Sim  <br/> |
|Controle organizacional da tela do dispositivo em ocioso  <br/> |Sim  <br/> |
|Controle organizacional de acesso de usuário para aplicativos do Microsoft Store  <br/> |Sim  <br/> |
|Controle organizacional de acesso de usuário a Cortana  <br/> |Sim  <br/> |
|Organizacional dicas de controle do Windows e publicidade da Microsoft  <br/> |Sim  <br/> |
