...
# [Descrições de serviços do Microsoft 365 e do Office 365](office-365-service-descriptions-technet-library.md)
## [Descrição dos serviços das plataformas Microsoft 365 e Office 365](office-365-platform-service-description/office-365-platform-service-description.md)
### [Opções de planos para Microsoft 365 e Office 365](office-365-platform-service-description/office-365-plan-options.md)
...
### [Recursos do pacote Microsoft 365](office-365-platform-service-description/office-365-suite-features.md)
...
## [Descrição do serviço SharePoint Syntex](sharepoint-syntex-service-description/sharepoint-syntex-service-description.md)
### [Recursos do SharePoint Syntex](sharepoint-syntex-service-description/sharepoint-syntex-features.md)
## [Descrição universal do Serviço de impressão](universal-print-service-description/universal-print-service-description.md)
## [Descrição do serviço Windows 365](windows-365-service-description/windows-365-service-description.md)
...
## [Descrição do serviço Microsoft Project](project-online-service-description/microsoft-planner-service-description.md)
## [Descrição do serviço do Microsoft Project](project-online-service-description/project-online-service-description.md)
### [Descrição do Microsoft Project para serviço Web](project-online-service-description/project-web-service-description.md)
### [Descrição do serviço de cliente da área de trabalho do Microsoft Project Online](project-online-service-description/project-online-desktop-client-service-description.md)
### [Descrição do serviço do Microsoft Project Online](project-online-service-description/microsoft-project-online-service-description.md)
...
### [Detalhe dos recursos do Visio](visio-online-service-description/visio-features.md)
## [Descrição do serviço Microsoft Viva](microsoft-viva-service-description.md)
## [Descrição do serviço do Yammer](yammer-service-description/yammer-service-description.md)
### [Limites no Yammer](yammer-service-description/yammer-limits.md)
...
### [Diretrizes do Microsoft 365 para segurança e conformidade](microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance.md)
...
## [Descrição do serviço Microsoft Bookings](microsoft-bookings-service-description.md)
