...
> [!NOTE]
><sup>+</sup>Ao instalar o Office 365 ou Office 2019, você obterá OneNote para Windows 10 por padrão. Para obter mais informações, consulte [Perguntas frequentes sobre OneNote](https://support.office.com/article/6582c7ae-2ec6-408d-8b7a-3ed71a3c2103).<br/>
><sup>++</sup>OneNote acesso a blocos de anotações no SharePoint Server, SharePoint Online, OneDrive for Business e Office 365. <br/>
...
<sup>9</sup> A ativação de volume para Office 365 E3 e Microsoft 365 Apps para Grandes Empresas estão limitadas a instalações no Windows Server 2008 R2 e mais novas com a função RDS habilitada ou Windows To Go instalações. Em ambos os casos, os usuários que acessam essas instalações precisam ser usuários licenciados do Office 365 E3 ou Microsoft 365 Apps para Grandes Empresas.<br/> 
...
## <a name="office-application-availability-in-office-for-mac-plans"></a>Office de aplicativos em Office para Mac planos
...
| Office aplicativo/recurso | CCG | CCG Alto | DOD |
|-----|-----|-----|-----|
|**[Microsoft Excel](office-applications.md#microsoft-excel)** está totalmente disponível nas nuvens do governo, com exceção dos seguintes recursos não disponíveis no momento:| Sim | Sim | Sim |
...
|**[Microsoft OneNote](office-applications.md#microsoft-onenote)** está totalmente disponível nas nuvens do governo, com exceção dos seguintes recursos não disponíveis no momento:| Sim | Sim | Sim |
...
|**Microsoft Whiteboard** nas nuvens do governo está disponível apenas em clientes Hub e não na área de trabalho. | Sim<sup>2</sup> | Sim<sup>2</sup> | Sim<sup>2</sup> |
...
|**[Microsoft Word](office-applications.md#microsoft-word)** está totalmente disponível nas nuvens do governo, com exceção dos seguintes recursos não disponíveis no momento:| Sim | Sim | Sim |
|Pesquisa Inteligente | Não | Não | Não |
|Pesquisador | Não | Não | Não |
...
> <sup>2</sup> Disponível em locais Surface Hub (não assinado).
