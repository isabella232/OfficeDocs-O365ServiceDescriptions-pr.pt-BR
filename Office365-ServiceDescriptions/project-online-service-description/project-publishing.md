...
description: Os seguintes SharePoint e Skype for Business de interoperabilidade estão disponíveis no Project Online.
ms.openlocfilehash: 0f1b65242a67c954c4908f112f9cb38a119e1b9c
ms.sourcegitcommit: c117bb958f5b94682fd384b4770a920c6114559b
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59672503"
---
# <a name="project-publishing"></a>Publicação de projetos

Os seguintes SharePoint e Skype for Business de interoperabilidade estão disponíveis no Project Online.
...
## <a name="save-a-project-mpp-file-on-sharepoint"></a>Salvar um Project MPP no SharePoint

Salve um projeto em uma SharePoint de documentos para compartilhar com membros da equipe que não têm Project Server. Saiba mais sobre [Sincronizar com uma lista de tarefas do SharePoint](https://go.microsoft.com/fwlink/p/?LinkId=271353).
  
## <a name="task-list-sync-to-sharepoint"></a>Sincronização de lista de tarefas com SharePoint
